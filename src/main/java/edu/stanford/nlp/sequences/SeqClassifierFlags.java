...
public class SeqClassifierFlags implements Serializable {
  ...
  public boolean useNearKeyWord=false;
  public boolean currentWord=false;
        public boolean isNumber=false;
        public boolean prevWord=false;
        public boolean prev2Word=false;
        public boolean next2Word=false;
        public boolean nextWord=false;
        public boolean initUpcaseCurrentWord=false;
        public boolean initUpcasePrevWord=false;
        public boolean initUpcasePrev2Word=false;
        public boolean initUpcaseNextWord=false;
        public boolean initUpcaseNext2Word=false;
        public boolean lowercaseCurrentWord=false;
        public boolean lowercasePrevWord=false;
        public boolean lowercaseNextWord=false;
        public boolean wordPairPC=false;
        public boolean wordPairCN=false;
        public boolean wordPairPN=false;
        public boolean allCapCurrentWord=false;
        public boolean allCapPrevWord=false;
        public boolean allCapPrev2Word=false;
        public boolean allCapNextWord=false;
        public boolean allCapNext2Word=false;
        public boolean letterAndDigitCWord=false;
        public boolean letterAndDigitPWord=false;
        public boolean letterAndDigitP2Word=false;
        public boolean letterAndDigitNWord=false;
        public boolean letterAndDigitN2Word=false;
        public boolean prefixCWord=false;
        public boolean prefixPWord=false;
        public boolean prefixP2Word=false;
        public boolean isPunctuationPWord=false;
        public boolean isPunctuationP2Word=false;
        public boolean isPunctuationNWord=false;
        public boolean isPunctuationN2Word=false;
        public boolean isBracket=false;
        public boolean isBracketPWord=false;
        public boolean isBracketP2Word=false;
        public boolean isBracketN2Word=false;
        public boolean isBracketNWord=false;
        public boolean isFirstSentenceWord=false;
        public boolean isFirstSentencePWord=false;
        public boolean isFirstSentenceP2Word=false;
        public boolean isInCountryList=false;
        public boolean isInCountryListPWord=false;
        public boolean isInCountryListP2Word=false;
        public boolean isInCountryListNWord=false;
        public boolean isInCountryListN2Word=false;
        public boolean isInVnFirstName=false;
        public boolean isInVnFirstNamePWord=false;
        public boolean isInVnFirstNameP2Word=false;
        public boolean isInVnFirstNameN2Word=false;
        public boolean isInVnFirstNameNWord=false;
        public boolean isInVnLastName=false;
        public boolean isInVnLastNamePWord=false;
        public boolean isInVnLastNameP2Word=false;
        public boolean isInVnLastNameNWord=false;
        public boolean isInVnLastNameN2Word=false;
        public boolean inLocDict=false;
        public boolean inLocDictPWord=false;
        public boolean inLocDictP2Word=false;
        public boolean inLocDictNWord=false;
        public boolean inLocDictN2Word=false;
        public boolean vnTimeMarkers=false;
        public boolean vnTimeMarkersPWord=false;
        public boolean vnTimeMarkersP2Word=false;
        public boolean vnTimeMarkersN2Word=false;
        public boolean vnTimeMarkersNWord=false;
        public boolean perIndicateNoun=false;
        public boolean perIndicateNounPWord=false;
        public boolean perIndicateNounP2Word=false;
        public boolean perIndicateNounNWord=false;
        public boolean perIndicateNounN2Word=false;
        public boolean locIndicateNounN2Word=false;
        public boolean locIndicateNounNWord=false;
        public boolean locIndicateNounPWord=false;
        public boolean locIndicateNounP2Word=false;
        public boolean locIndicateNoun=false;
        public boolean orgIndicateNoun=false;
        public boolean orgIndicateNounPWord=false;
        public boolean orgIndicateNounP2Word=false;
        public boolean orgIndicateNounNWord=false;
        public boolean orgIndicateNounN2Word=false;
        public boolean tag=false;
        public boolean pTag=false;
        public boolean p2Tag=false;
        public boolean nTag=false;
        public boolean n2Tag=false;
        public boolean postfixCWord=false;
        public boolean postfixPWord=false;
        public boolean postfixNWord=false;
        
       
// 
  public boolean useLocDictHNHCM=false;
...
//Sua cho nay
  public String map = "word=0,answer=1";
  //Ket thuc sua de test
...
//Sua cho nay Vietnamese
  ...
  //tieng viet
  public   boolean useNumberUpcase=false;
  public boolean useInitUpcase=false;
  public boolean usePrevWordInOrgIndicateNounDict=false;
  public boolean usePrevWordLocIndicateVerbDict=false;
  public boolean usePrevWordLocIndicateAdverbDict=false;
  public boolean usePrevWordLocIndicateNounDict=false;
  public boolean usePrevWordDefineDict=false;
  public boolean usePrevWordPerIndicateNounDict=false;
  public boolean useNext2WordPerIndicateNounDict=false;
  public boolean usePrev2WordLocIndicateVerbDict=false;
  public boolean usePrev2WordLocIndicateAdverbDict=false;
  public boolean useLocDict=false;
  public boolean useNumberUpcasePrev=false;
  public boolean useNumberUpcaseNext=false;
  public boolean useInitUpcaseNext=false;
  public boolean useInitUpcasePrev=false;
  public boolean useDefineDict=false;
  public boolean useConJunctionDict=false;
  public boolean useLocIndicateAdverbDict=false;
  public boolean useLocIndicateNounDict=false;
  public boolean useLocIndicateVerbDict=false;
  public boolean useOrgIndicateNounDict=false;
  public boolean usePerIndicateNounDict=false;
  public boolean usePerLocAmbiguityDict=false;
  ///////
  //Nhom feature moi
  ...
  public void setProperties(Properties props, boolean printProps) {
    ...
    for (Enumeration e = props.propertyNames(); e.hasMoreElements();) {
      ...
      //tieng viet
      else if(key.equalsIgnoreCase("isNumber"))
      {
          isNumber=Boolean.parseBoolean("isNumber");
      }
      else if(key.equalsIgnoreCase("useLocDictHNHCM"))
      {
          useLocDictHNHCM=Boolean.parseBoolean(val);
      }
      else if(key.equals("useNearKeyWord"))
      {
          useNearKeyWord=Boolean.parseBoolean(val);
      }
      else if(key.equalsIgnoreCase("usePerLocAmbiguityDict"))
          usePerLocAmbiguityDict=Boolean.parseBoolean(val);
      else if(key.equalsIgnoreCase("usePerIndicateNounDict"))
          usePerIndicateNounDict=Boolean.parseBoolean(val);
      else if(key.equalsIgnoreCase("useOrgIndicateNounDict"))
          useOrgIndicateNounDict=Boolean.parseBoolean(val);
      else if(key.equalsIgnoreCase("useLocIndicateVerbDict"))
          useLocIndicateVerbDict=Boolean.parseBoolean(val);
      else if(key.equalsIgnoreCase("useLocIndicateNounDict"))
          useLocIndicateNounDict=Boolean.parseBoolean(val);
      else if(key.equalsIgnoreCase("useLocIndicateAdverbDict"))
          useLocIndicateAdverbDict=Boolean.parseBoolean(val);
      else if(key.equalsIgnoreCase("useDefineDict"))
      {
          useDefineDict=Boolean.parseBoolean(val);
      }
      else if(key.equalsIgnoreCase("useConJunctionDict"))
          useConJunctionDict=Boolean.parseBoolean(val);
      else if(key.equalsIgnoreCase("useNumberUpcaseNext"))
      {
          useNumberUpcaseNext=Boolean.parseBoolean(val);
      }
      else if(key.equalsIgnoreCase("useNumberUpcasePrev"))
      {
          useNumberUpcasePrev=Boolean.parseBoolean(val);
      }
      else if(key.equalsIgnoreCase("useLocDict"))
      {
          useLocDict=Boolean.parseBoolean(val);
      }
      else if(key.equalsIgnoreCase("useInitUpcasePrev"))
      {
          useInitUpcasePrev=Boolean.parseBoolean(val);
                  
      }
      else if(key.equalsIgnoreCase("useInitUpcaseNext"))
      {
          useInitUpcaseNext=Boolean.parseBoolean(val);
      }
      else if(key.equalsIgnoreCase("usePrev2WordLocIndicateAdverbDict"))
      {
          usePrev2WordLocIndicateAdverbDict=Boolean.parseBoolean(val);
      }
      else if(key.equalsIgnoreCase("usePrev2WordLocIndicateVerbDict"))
      {
          usePrev2WordLocIndicateVerbDict=Boolean.parseBoolean(val);
      }
      else if(key.equalsIgnoreCase("useNumberUpcase"))
      {
          useNumberUpcase=Boolean.parseBoolean(val);
          
      } 
      
      else if(key.equalsIgnoreCase("useInitUpcase"))
      {
          useInitUpcase=Boolean.parseBoolean(val);
      }
      else if(key.equalsIgnoreCase("usePrevWordInOrgIndicateNounDict"))
      {
          usePrevWordInOrgIndicateNounDict=Boolean.parseBoolean(val);
      }
      else if(key.equalsIgnoreCase("usePrevWordLocIndicateVerbDict"))
      {
          usePrevWordLocIndicateVerbDict=Boolean.parseBoolean(val);
      }
       else if(key.equalsIgnoreCase("usePrevWordLocIndicateAdverbDict"))
      {
          usePrevWordLocIndicateAdverbDict=Boolean.parseBoolean(val);
      }
        else if(key.equalsIgnoreCase("usePrevWordLocIndicateNounDict"))
      {
          usePrevWordLocIndicateNounDict=Boolean.parseBoolean(val);
      }
         else if(key.equalsIgnoreCase("usePrevWordDefineDict"))
      {
          usePrevWordDefineDict=Boolean.parseBoolean(val);
      }
          else if(key.equalsIgnoreCase("usePrevWordPerIndicateNounDict"))
      {
          usePrevWordPerIndicateNounDict=Boolean.parseBoolean(val);
      }
          else if(key.equalsIgnoreCase("useNext2WordPerIndicateNounDict"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("currentWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("prevWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("prev2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("next2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("nextWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("initUpcaseCurrentWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("initUpcasePrevWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("initUpcasePrev2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("initUpcaseNextWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("initUpcaseNext2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("lowercaseCurrentWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("lowercasePrevWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("lowercaseNextWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("wordPairPC"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("wordPairCN"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("wordPairPN"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("allCapCurrentWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("allCapPrevWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          
          else if(key.equalsIgnoreCase("allCapPrev2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          
          else if(key.equalsIgnoreCase("allCapNextWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("allCapNext2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("letterAndDigitCWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("letterAndDigitPWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("letterAndDigitP2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("letterAndDigitNWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("letterAndDigitN2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("prefixCWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("prefixPWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("prefixP2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          
       
          else if(key.equalsIgnoreCase("isPunctuationPWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("isPunctuationP2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("isPunctuationNWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("isPunctuationN2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("isBracket"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("isBracketPWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("isBracketP2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("isBracketN2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("isBracketNWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("isFirstSentenceWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("isFirstSentencePWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("isFirstSentenceP2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("isInCountryList"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("isInCountryListPWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("isInCountryListP2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("isInCountryListNWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("isInCountryListN2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("isInVnFirstName"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("isInVnFirstNamePWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("isInVnFirstNameP2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("isInVnFirstNameN2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("isInVnFirstNameNWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("isInVnLastName"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("isInVnLastNamePWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          
          else if(key.equalsIgnoreCase("isInVnLastNameP2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          
          else if(key.equalsIgnoreCase("isInVnLastNameNWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("isInVnLastNameN2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("inLocDict"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("inLocDictPWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("inLocDictP2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("inLocDictNWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          
          else if(key.equalsIgnoreCase("inLocDictN2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("vnTimeMarkers"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("vnTimeMarkersPWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("vnTimeMarkersP2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("vnTimeMarkersN2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("vnTimeMarkersNWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("perIndicateNoun"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          
          else if(key.equalsIgnoreCase("perIndicateNounPWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          
          else if(key.equalsIgnoreCase("perIndicateNounP2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          
          else if(key.equalsIgnoreCase("perIndicateNounNWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("perIndicateNounN2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          
          else if(key.equalsIgnoreCase("locIndicateNounN2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("locIndicateNounNWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("locIndicateNounPWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          
          else if(key.equalsIgnoreCase("locIndicateNounP2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("locIndicateNoun"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("orgIndicateNoun"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("orgIndicateNounPWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("orgIndicateNounP2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("orgIndicateNounNWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("orgIndicateNounN2Word"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          ...
          else if(key.equalsIgnoreCase("pTag"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("p2Tag"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("nTag"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("n2Tag"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("postfixCWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("postfixPWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
          else if(key.equalsIgnoreCase("postfixNWord"))
          {
              useNext2WordPerIndicateNounDict=Boolean.parseBoolean(val);
          }
